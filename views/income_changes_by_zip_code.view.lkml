view: income_changes_by_zip_code {
  derived_table: {
    sql: WITH utah_acs_changes_2011_2017 AS (WITH
        utah_fips AS (
        SELECT
          state_fips_code
        FROM
      ...
      SELECT
        utah_acs_changes_2011_2017.zip_code,
        utah_acs_changes_2011_2017.diff_income_per_capita,
        utah_acs_changes_2011_2017.diff_rate_bachelors_degree_or_higher_25_64
      FROM utah_acs_changes_2011_2017
